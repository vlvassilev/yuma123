...
status_t y_intri_diagnostic_init(
  ...
  res = agt_rpc_register_method(
      y_M_intri_diagnostic,
      "intri-diagnostic-Diagnostic-RunPingTest",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_diagnostic,
      "intri-diagnostic-Diagnostic-RunTraceRoute",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_diagnostic,
      "intri-diagnostic-Diagnostic-RunDNSLookup",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_diagnostic,
      "intri-diagnostic-Diagnostic-GetARPTable",
      AGT_RPC_PH_INVOKE,
...
status_t y_intri_diagnostic_init2(void) {
  status_t res = NO_ERR;
  return res;
}
