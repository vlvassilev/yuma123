...
static status_t intri_timerange_TimeRange_GetConfig_invoke(
  ...
  errstr->n = 0;
  timerange_TimeRange_GetConfig(in, out, errstr);
  if (errstr->n >0) {
...
static status_t intri_timerange_TimeRange_GetStatus_invoke(
  ...
  errstr->n = 0;
  timerange_TimeRange_GetStatus(in, out, errstr);
  if (errstr->n >0) {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ncx_errinfo_t *errinfo = ncx_new_errinfo();
...
static status_t intri_timerange_TimeRange_AddTimeRange_invoke(
  ...
  errstr->n = 0;
  timerange_TimeRange_AddTimeRange(in, out, errstr);
  if (errstr->n >0) {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ncx_errinfo_t *errinfo = ncx_new_errinfo();
...
static status_t intri_timerange_TimeRange_DeleteTimeRange_invoke(
  ...
  errstr->n = 0;
  timerange_TimeRange_DeleteTimeRange(in, out, errstr);
  if (errstr->n >0) {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ncx_errinfo_t *errinfo = ncx_new_errinfo();
...
static status_t intri_timerange_TimeRange_UpdateTimeRange_invoke(
  ...
  errstr->n = 0;
  timerange_TimeRange_UpdateTimeRange(in, out, errstr);
  if (errstr->n >0) {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ncx_errinfo_t *errinfo = ncx_new_errinfo();
