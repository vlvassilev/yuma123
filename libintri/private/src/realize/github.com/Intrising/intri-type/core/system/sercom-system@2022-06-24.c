...
static status_t intri_system_System_SetConfig_invoke(
  ...
  errstr->n = 0;
  system_System_GetConfig(out, in, errstr);
  if (errstr->n > 0) {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ncx_errinfo_t *errinfo = ncx_new_errinfo();
...
static status_t intri_system_System_GetStatus_invoke(
  ...
  status_t res = NO_ERR;
  struct emptypb_Empty *in = malloc(sizeof(*in));
  struct systempb_Status *out = malloc(sizeof(*out));
  GoString *errstr = malloc(sizeof(*errstr));

  errstr->n = 0;
  system_System_GetStatus(in, out, errstr);
  if (errstr->n >0) {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ncx_errinfo_t *errinfo = ncx_new_errinfo();
  ...
  res = build_to_xml_system_Status(outval, out);
  if (res != NO_ERR) {
    free(in);
    free(out);
    free(errstr);
...
status_t y_sercom_system_init(
  ...
  res = agt_rpc_register_method(
      y_M_intri_system,
      "sercom-system-System-GetConfig",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_system,
      "sercom-system-System-SetConfig",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_system,
      "sercom-system-System-GetStatus",
      AGT_RPC_PH_INVOKE,
...
status_t y_sercom_system_init2(void) {
  status_t res = NO_ERR;
  return res;
}

void y_sercom_system_cleanup(void) {
