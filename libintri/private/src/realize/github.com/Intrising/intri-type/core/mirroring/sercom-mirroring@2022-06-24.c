...
#include "sercom-mirroring@2022-06-24.h"
...
static status_t intri_mirroring_Mirroring_GetConfig_invoke(
  ...
  errstr->n = 0;
  mirroring_Mirroring_GetConfig(in, out, errstr);
  if (errstr->n >0) {
...
static status_t intri_mirroring_Mirroring_GetRSPAN_invoke(
  ...
  errstr->n = 0;
  mirroring_Mirroring_GetRSPAN(in, out, errstr);
  if (errstr->n >0) {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ncx_errinfo_t *errinfo = ncx_new_errinfo();
...
static status_t intri_mirroring_Mirroring_SetRSPAN_invoke(
  ...
  errstr->n = 0;
  mirroring_Mirroring_GetRSPAN(out, in, errstr);
  if (errstr->n > 0) {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ncx_errinfo_t *errinfo = ncx_new_errinfo();
  ...
  errstr->n = 0;
  mirroring_Mirroring_SetRSPAN(in, out, errstr);
  if (errstr->n >0) {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ncx_errinfo_t *errinfo = ncx_new_errinfo();
...
static status_t intri_mirroring_Mirroring_GetDestinationList_invoke(
  ...
  errstr->n = 0;
  mirroring_Mirroring_GetDestinationList(in, out, errstr);
  if (errstr->n >0) {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ncx_errinfo_t *errinfo = ncx_new_errinfo();
...
static status_t intri_mirroring_Mirroring_AddDestination_invoke(
  ...
  errstr->n = 0;
  mirroring_Mirroring_AddDestination(in, out, errstr);
  if (errstr->n >0) {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ncx_errinfo_t *errinfo = ncx_new_errinfo();
...
static status_t intri_mirroring_Mirroring_DeleteDestination_invoke(
  ...
  errstr->n = 0;
  mirroring_Mirroring_DeleteDestination(in, out, errstr);
  if (errstr->n >0) {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ncx_errinfo_t *errinfo = ncx_new_errinfo();
...
static status_t intri_mirroring_Mirroring_UpdateDestination_invoke(
  ...
  errstr->n = 0;
  mirroring_Mirroring_UpdateDestination(in, out, errstr);
  if (errstr->n >0) {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ncx_errinfo_t *errinfo = ncx_new_errinfo();
...
static status_t intri_mirroring_Mirroring_GetSourceList_invoke(
  ...
  errstr->n = 0;
  mirroring_Mirroring_GetSourceList(in, out, errstr);
  if (errstr->n >0) {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ncx_errinfo_t *errinfo = ncx_new_errinfo();
...
static status_t intri_mirroring_Mirroring_AddSource_invoke(
  ...
  errstr->n = 0;
  mirroring_Mirroring_AddSource(in, out, errstr);
  if (errstr->n >0) {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ncx_errinfo_t *errinfo = ncx_new_errinfo();
...
static status_t intri_mirroring_Mirroring_DeleteSource_invoke(
  ...
  errstr->n = 0;
  mirroring_Mirroring_DeleteSource(in, out, errstr);
  if (errstr->n >0) {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ncx_errinfo_t *errinfo = ncx_new_errinfo();
...
static status_t intri_mirroring_Mirroring_UpdateSource_invoke(
  ...
  errstr->n = 0;
  mirroring_Mirroring_UpdateSource(in, out, errstr);
  if (errstr->n >0) {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ncx_errinfo_t *errinfo = ncx_new_errinfo();
...
status_t y_sercom_mirroring_init(
  ...
  res = agt_rpc_register_method(
      y_M_intri_mirroring,
      "sercom-mirroring-Mirroring-GetConfig",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_mirroring,
      "sercom-mirroring-Mirroring-GetRSPAN",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_mirroring,
      "sercom-mirroring-Mirroring-SetRSPAN",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_mirroring,
      "sercom-mirroring-Mirroring-GetDestinationList",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_mirroring,
      "sercom-mirroring-Mirroring-AddDestination",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_mirroring,
      "sercom-mirroring-Mirroring-DeleteDestination",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_mirroring,
      "sercom-mirroring-Mirroring-UpdateDestination",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_mirroring,
      "sercom-mirroring-Mirroring-GetSourceList",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_mirroring,
      "sercom-mirroring-Mirroring-AddSource",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_mirroring,
      "sercom-mirroring-Mirroring-DeleteSource",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_mirroring,
      "sercom-mirroring-Mirroring-UpdateSource",
      AGT_RPC_PH_INVOKE,
...
status_t y_sercom_mirroring_init2(void) {
  status_t res = NO_ERR;
  return res;
}

void y_sercom_mirroring_cleanup(void) {
