...
#include "sercom-port@2022-06-24.h"
...
status_t y_sercom_port_init(
  ...
  res = agt_rpc_register_method(
      y_M_intri_port,
      "sercom-port-Port-UpdateAliasConfig",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_port,
      "sercom-port-Port-UpdateOperationConfig",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_port,
      "sercom-port-Port-UpdateSpeedDuplexConfig",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_port,
      "sercom-port-Port-UpdateFlowControlConfig",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_port,
      "sercom-port-Port-UpdateEnergyEfficiencyConfig",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_port,
      "sercom-port-Port-RunRestartPorts",
      AGT_RPC_PH_INVOKE,
...
status_t y_sercom_port_init2(void) {
  status_t res = NO_ERR;
  return res;
}

void y_sercom_port_cleanup(void) {
