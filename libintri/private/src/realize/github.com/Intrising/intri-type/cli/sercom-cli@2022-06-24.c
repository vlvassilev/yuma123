...
#include "sercom-cli@2022-06-24.h"
...
static status_t intri_cli_CLI_RunScript_invoke(
  ...
  errstr->n = 0;
  cli_CLI_RunScript(in, out, errstr);
  if (errstr->n >0) {
...
status_t y_sercom_cli_init2(void) {
  status_t res = NO_ERR;
  return res;
}

void y_sercom_cli_cleanup(void) {
