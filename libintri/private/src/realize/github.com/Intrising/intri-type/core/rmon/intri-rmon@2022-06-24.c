...
status_t y_intri_rmon_init(
  ...
  res = agt_rpc_register_method(
      y_M_intri_rmon,
      "intri-rmon-RMON-RunClearAllCounter",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_rmon,
      "intri-rmon-RMON-GetUtilization",
      AGT_RPC_PH_INVOKE,
...
status_t y_intri_rmon_init2(void) {
  status_t res = NO_ERR;
  return res;
}
