...
status_t yangrpc_exec(server_cb_t *server_cb, val_value_t* request_val, val_value_t** reply_val)
{
    status_t res;
    ses_cb_t* scb;
    mgr_rpc_req_t         *req;
...
void yangrpc_close(server_cb_t *server_cb)
{
}
...
int main(int argc, char* argv[])
{
    ...
    assert(res==NO_ERR);
    server_cb = yangrpc_connect("127.0.0.1"/*host*/,"root"/*user*/,"blah"/*pass*/);
    ...
    res = yangrpc_exec(server_cb, request_val, &reply_val);
    assert(res==0);
