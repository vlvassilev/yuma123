...
status_t y_intri_portsecurity_init(
  ...
  res = agt_rpc_register_method(
      y_M_intri_portsecurity,
      "intri-portsecurity-PortSecurity-GetConfig",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_portsecurity,
      "intri-portsecurity-PortSecurity-UpdatePortSecurityConfig",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_portsecurity,
      "intri-portsecurity-PortSecurity-AddPortSecureEntry",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_portsecurity,
      "intri-portsecurity-PortSecurity-DeletePortSecureEntry",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_portsecurity,
      "intri-portsecurity-PortSecurity-GetPortSecurityInfo",
      AGT_RPC_PH_INVOKE,
...
status_t y_intri_portsecurity_init2(void) {
  status_t res = NO_ERR;
  return res;
}
