/*
    module ietf-interfaces for NMDA enabled ietf-interfaces
...
/* The 3 mandatory callback functions: y_ietf_interfaces_w_nmda_init, y_ietf_interfaces_w_nmda_init2, y_ietf_interfaces_w_nmda_cleanup */
...
status_t y_ietf_interfaces_w_nmda_init2(void)
{
    status_t res;
    val_value_t* interfaces_val;
    uint32 timer_id;
...
void y_ietf_interfaces_w_nmda_cleanup (void)
{
}
