    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_GetConfig(in, out, errstr);
  if (errstr->n > 0)
  {
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_GetManagementConfig(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_GetManagementConfig(out, in, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
  ...
  errstr->n = 0;
  vlan_VLAN_UpdateManagementConfig(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_GetVoiceConfig(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_GetVoiceConfig(out, in, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
  ...
  errstr->n = 0;
  vlan_VLAN_UpdateVoiceConfig(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_GetFiltersConfig(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  // errstr->n = 0;
  vlan_VLAN_AddFilter(in, out, errstr);
  printf("n=%d, p=%s", errstr->n, errstr->p);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_UpdateFilter(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_DeleteFilter(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_GetPortsConfig(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_GetPortsConfig(out, in, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
  ...
  errstr->n = 0;
  vlan_VLAN_UpdatePortsConfig(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_GetMappingConfig(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_AddMapping(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_DeleteMapping(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_UpdateMappingPortEntry(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_GetSelectiveQinQConfig(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_AddSelectiveQinQ(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_UpdateSelectiveQinQ(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_DeleteSelectiveQinQ(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_GetProtocolBasedConfig(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_AddProtocolBasedGroup(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_UpdateProtocolBasedGroup(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_DeleteProtocolBasedGroup(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_AddProtocolBasedGroupMember(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_UpdateProtocolBasedGroupMember(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_DeleteProtocolBasedGroupMember(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_GetMACBasedConfig(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_AddMACBasedGroup(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_UpdateMACBasedGroup(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_DeleteMACBasedGroup(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_AddMACBasedGroupMember(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_UpdateMACBasedGroupMember(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_DeleteMACBasedGroupMember(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_GetSubnetBasedConfig(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_AddSubnetBasedGroup(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_UpdateSubnetBasedGroup(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_DeleteSubnetBasedGroup(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_AddSubnetBasedGroupMember(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_UpdateSubnetBasedGroupMember(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_DeleteSubnetBasedGroupMember(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
    ...
    xml_node_t *methnode)
{
  ...
  errstr->n = 0;
  vlan_VLAN_GetManagementVlanPorts(in, out, errstr);
  if (errstr->n > 0)
  {
    const xmlChar *errorstr = NULL;
    val_value_t *errorval = NULL;
