...
status_t y_intri_udld_init(
  ...
  res = agt_rpc_register_method(
      y_M_intri_udld,
      "intri-udld-UDLD-RunRestorePortStatus",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_udld,
      "intri-udld-UDLD-GetBasicConfig",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_udld,
      "intri-udld-UDLD-UpdateBasicConfig",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_udld,
      "intri-udld-UDLD-UpdatePortConfig",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_udld,
      "intri-udld-UDLD-UpdatePortConfigEntry",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_udld,
      "intri-udld-UDLD-RunClearStatistics",
      AGT_RPC_PH_INVOKE,
...
status_t y_intri_udld_init2(void) {
  status_t res = NO_ERR;
  return res;
}
