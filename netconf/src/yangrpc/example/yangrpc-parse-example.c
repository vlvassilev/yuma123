...
int main(int argc, char* argv[])
{
    ...
    assert(res==NO_ERR);
    yangrpc_cb = yangrpc_connect("185.35.202.50"/*server*/, 830/*port*/, "root"/*user*/,"hadm1_123"/*password*/,"/home/vladimir/.ssh/id_rsa.pub"/*public_key*/, "/home/vladimir/.ssh/id_rsa"/*private_key*/);
    assert(yangrpc_cb!=NULL);

    res = yangrpc_parse_cli(yangrpc_cb, "xget /interfaces-state", &request_val);
    assert(res==0);
