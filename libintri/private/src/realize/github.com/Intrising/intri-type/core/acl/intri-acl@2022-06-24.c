...
status_t y_intri_acl_init(
  ...
  res = agt_rpc_register_method(
      y_M_intri_acl,
      "intri-acl-ACL-GetInterfaceList",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_acl,
      "intri-acl-ACL-UpdateInterfaceList",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_acl,
      "intri-acl-ACL-GetFlowMirroringList",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_acl,
      "intri-acl-ACL-AddFlowMirroring",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_acl,
      "intri-acl-ACL-DeleteFlowMirroring",
      AGT_RPC_PH_INVOKE,
  ...
  res = agt_rpc_register_method(
      y_M_intri_acl,
      "intri-acl-ACL-UpdateFlowMirroring",
      AGT_RPC_PH_INVOKE,
...
status_t y_intri_acl_init2(void) {
  status_t res = NO_ERR;
  return res;
}
