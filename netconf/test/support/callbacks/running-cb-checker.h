#ifndef __RUNNING_CALLBACK_CHECKER_H
#define __RUNNING_CALLBACK_CHECKER_H
...
/**
 * Support class for checking callback information when editing the running
 * database directly.
 */
class RunningCBChecker : public CallbackChecker
{
public:
    /** Constructor. */
    RunningCBChecker();
...
#endif // __RUNNING_CALLBACK_CHECKER_H
