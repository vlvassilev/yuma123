...
#define y_device_test_N_connection (const xmlChar *)"connection"
...
/* list /xpo/profile/stream/connection */
typedef struct y_device_test_T_xpo_profile_stream_connection_ {
    dlq_hdr_t qhdr;
    uint32 id;
    uint32 sourceId;
    uint32 sourcePinId;
    ...
    uint32 bitrate;
} y_device_test_T_xpo_profile_stream_connection;
...
/* device_test module init 1 */
extern status_t
    y_device_test_init (
        const xmlChar *modname,
        const xmlChar *revision);

/* device_test module init 2 */
extern status_t
    y_device_test_init2 (void);

/* device_test module cleanup */
extern void
