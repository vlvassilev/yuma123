...
status_t y_intri_cdp_init(
  ...
  res = agt_rpc_register_method(
      y_M_intri_cdp,
      "intri-cdp-CDP-RunClearStatistic",
      AGT_RPC_PH_INVOKE,
...
status_t y_intri_cdp_init2(void) {
  status_t res = NO_ERR;
  return res;
}
