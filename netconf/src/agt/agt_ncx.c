                          ...
                          val_value_t      **srcval )
{
    ...
    if ( NO_ERR == res ) {
        ...
        res = agt_get_url_from_parm( NCX_EL_SOURCE, msg, methnode, &srcurl );
        if ( NO_ERR == res ) {
            if ( srcurl )
            {
    ...
    if (res != NO_ERR) {
         ...
         */
        val_value_t* errval = val_find_child( msg->rpc_input, NC_MODULE, 
                                              NCX_EL_SOURCE );
                        ...
                        xmlChar          **desturlspec )
{
    ...
    if (res == NO_ERR ) {
        ...
        res = agt_get_url_from_parm( NCX_EL_TARGET, msg, methnode, &desturl );
        if ( NO_ERR == res ) {
            if ( desturl ) {
